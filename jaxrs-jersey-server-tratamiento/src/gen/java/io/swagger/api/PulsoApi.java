...
public class PulsoApi  {
   ...
   public PulsoApi(@Context ServletConfig servletContext) {
    ...
    @io.swagger.annotations.ApiOperation(value = "Obtener datos de pulso del usuario", notes = "Obtener datos de pulso del usuario", response = Object.class, tags={ "Basic", })
    ...
    public Response obtenerPulso(@ApiParam(value = "Value to store",required=true) @QueryParam("usuarioId") Integer usuarioId
